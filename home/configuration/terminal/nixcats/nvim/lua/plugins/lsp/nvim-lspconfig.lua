local function lsp_on_attach(_, bufnr)
  ...
  nmap('<leader>ldd', vim.lsp.buf.definition, '[G]oto [D]efinition')
  nmap('<leader>ldt', vim.lsp.buf.type_definition, 'Type [D]efinition')
  nmap('<leader>ldh', vim.lsp.buf.hover, 'Hover Documentation')
  nmap('<leader>lds', vim.lsp.buf.signature_help, 'Signature Documentation')
